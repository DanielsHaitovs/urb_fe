...
import type { ChangeEvent, FormEventHandler, JSX } from 'react'
import { useEffect, useState } from 'react'
import { createPortal } from 'react-dom'
import { useTranslations } from 'next-intl'
import { X } from 'lucide-react'
import styles from '@/components/ContactCTA/Modal/Form.module.scss'
...
export default function ModalContactForm({
  ...
  const getErrorId = (field: FormField): string | undefined =>
