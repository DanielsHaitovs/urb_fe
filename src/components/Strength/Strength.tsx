...
export default function Strength({ screen }: { screen: ScreenType }) {
...
function StatCard({ stat, delay, title, body, shouldAnimate }: StatCardProps) {
  const displayValue = useCountUp(stat.value, shouldAnimate, stat.duration ?? 1400);
...
function useCountUp(target: number, shouldStart: boolean, duration: number) {
